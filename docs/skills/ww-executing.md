...
- The Plan (`plan.md` + `tasks.md` + `spec.md` / `design.md`) is the **operative truth**; docs lag and are merged by `ww-archiving`.
...
- **Gate cadence.** Self-review default-on, skippable; user acceptance is a HARD-GATE.
