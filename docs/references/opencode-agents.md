...
A restricted agent designed for planning and analysis. It uses a permission system to give you more control and prevent unintended changes. By default, all of the following are set to `ask`:
...
> **Tip**: Do you have an agent you'd like to share? Submit a PR at [github.com/anomalyco/opencode](https://github.com/anomalyco/opencode).
